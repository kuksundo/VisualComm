...
uses
  ...
  EasterEgg, ConsoleDebug, pjhFormDesigner, pjhClasses,
...
{$IFDEF DESIGN_DEBUG_MODE},pjhObjectInspectorBpl {$ENDIF}
...
{$ENDIF}
  ...
  protected
    ...
    FDesignDebugMode: Boolean;//DesignManager_Debug.exe로 실행하면 True
...
{$IFDEF DESIGN_DEBUG_MODE}
      ...
      if (LStr = '..\Bpls\pjhDelphiStandardPkg.bpl') or
        (LStr = '..\Bpls\pjhFlowChart.bpl') then
        Continue;
{$ENDIF}

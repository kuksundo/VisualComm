...
function TpjhjvGIFAnimator_pjh.GetNextStepListWithComma: string;
begin
  Result := '';
...
function TpjhjvGIFAnimator_pjh.GetPrevStepListWithComma: string;
begin
  Result := '';
...
function TpjhjvGIFAnimator_pjh.GetXStepNameListWithComma: string;
begin

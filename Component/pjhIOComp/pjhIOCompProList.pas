...
begin
  ...
  LStr := LStr + 'TpjhiLedArrow;TpjhiLedArrow2;TpjhiLedDiamond;';
...
//해결: exe와 bpl project option에서 vcl.dcp와 rtl.dcp를 포함해줌(release version)
  ...
  RegisterClasses([TpjhiLedArrow,TpjhiLedArrow2,TpjhiLedDiamond]);
...
finalization
  ...
  UnRegisterClasses([TpjhiLedArrow,TpjhiLedArrow2,TpjhiLedDiamond]);

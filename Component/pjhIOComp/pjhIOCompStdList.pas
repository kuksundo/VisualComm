...
procedure Register;
begin
  RegisterComponents ('pjhIOCompStd',[TpjhiAnalogOutPut,TpjhiAnalogDisplay]);
  RegisterComponents ('pjhIOCompStd',[TpjhiAngularGauge,TpjhiEdit]);
  RegisterComponents ('pjhIOCompStd',[TpjhiGradient,TpjhiIntegerOutput]);
  RegisterComponents ('pjhIOCompStd',[TpjhiKnob,TpjhiLabel]);
  RegisterComponents ('pjhIOCompStd',[TpjhiLedBar,TpjhiLedRectangle]);
  RegisterComponents ('pjhIOCompStd',[TpjhiLedRound,TpjhiLedSpiral]);
  RegisterComponents ('pjhIOCompStd',[TpjhiLinearGauge,TpjhiOdometer]);
  RegisterComponents ('pjhIOCompStd',[TpjhiSevenSegmentInteger,TpjhiSevenSegmentHexaDecimal]);
  RegisterComponents ('pjhIOCompStd',[TpjhiSevenSegmentBinary,TpjhiSevenSegmentAnalog]);
  RegisterComponents ('pjhIOCompStd',[TpjhiSlider,TpjhiSwitchLed]);
  RegisterComponents ('pjhIOCompStd',[TpjhiSwitchPanel,TpjhiSwitchRotary]);
  RegisterComponents ('pjhIOCompStd',[TpjhiSwitchSlider,TpjhiSwitchToggle]);
  RegisterComponents ('pjhIOCompStd',[TpjhiThermoMeter]);
end;

...
procedure Register;
begin
  RegisterComponents ('pjhTMSSmoothComp', [TpjhadvSmoothGauge,TpjhAdvSmoothLabel,TpjhAdvSmoothPanel]);
  RegisterComponents ('pjhTMSSmoothComp', [TpjhAdvSmoothTrackBar,TpjhAdvSmoothStatusIndicator]);
  RegisterComponents ('pjhTMSSmoothComp', [TpjhAdvSmoothProgressBar,TpjhAdvSmoothToggleButton]);
  RegisterComponents ('pjhTMSSmoothComp', [TpjhAdvSmoothLedLabel,TpjhAdvSmoothExpanderPanel]);
  RegisterComponents ('pjhTMSSmoothComp', [TpjhAdvSmoothExpanderButtonPanel,TpjhAdvSmoothTimeLine]);
  RegisterComponents ('pjhTMSSmoothComp', [TpjhAdvSmoothCalculator,TpjhAdvSmoothCalculatorDropDown]);
end;
